...
<img src="assets/ForREADME/Struct.jpg" width="938" alt="Структура устройства">
...
<img src="assets/ForREADME/QR-code.png" width="250" alt="QR-код на сайт">
...
```bash
ASKDZ/
├── assets/              # Графические материалы проекта
│    ├── ForREADME       # Материалы для заполнения README
│    └── signs           # Графическое отображение неисправных дорожных знаков
